...
/**
 * unary function mapping interface to kdb
 */
public class Log10Function implements KdbFunction {
    private final String stdOperator;

    public Log10Function(String operator) {
    ...
    public KdbColumn render(List<KdbColumn> strings) {
        ...
        return KdbColumn.name(null, "(" + stdOperator + ";10;" + Joiner.on(";").join(exprs) + ")", names.toArray(new String[0]));
    }
}
