 ...
 */
public class KdbIntermediateScanPrel extends ScanRelBase implements KdbPrel {//AbstractRelNode implements Prel, CustomPrel {

    public KdbIntermediateScanPrel(RelOptCluster cluster, RelTraitSet replace, RelOptTable table, TableMetadata tableMetadata, List<SchemaPath> projectedColumns, double observedRowcountAdjustment) {
        super(cluster, replace, table, tableMetadata.getStoragePluginId(), tableMetadata, projectedColumns, observedRowcountAdjustment);
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        ...
        return new KdbIntermediateScanPrel(getCluster(), traitSet, getTable(), getTableMetadata(), getProjectedColumns(), getCostAdjustmentFactor());
    }

    @Override
    public ScanRelBase cloneWithProject(List<SchemaPath> projection) {
        return new KdbIntermediateScanPrel(getCluster(), traitSet, getTable(), getTableMetadata(), projection, getCostAdjustmentFactor());
    }
