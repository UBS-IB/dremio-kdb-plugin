/*
 * Copyright (C) ${project.inceptionYear} Dremio Corporation
 *
    ...
    Object r() throws UnsupportedEncodingException {
        ...
        switch (t) {
            ...
            case 6:
                ...
                return I;
            case 7:
                //should be able to start here to change these allocations to reads into arrow buffers...requires taking apart the message header
                long[] J = new long[n];
                for (; i < n; i++) {
                    J[i] = rj();
                }
